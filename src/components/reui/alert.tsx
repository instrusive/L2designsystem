  ...
  ],
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-destructive/30 bg-destructive/4 [&>svg]:text-destructive-foreground",
        info: "border-info/30 bg-info/4 [&>svg]:text-info-foreground",
        success: "border-success/30 bg-success/4 [&>svg]:text-success-foreground",
        warning: "border-warning/30 bg-warning/4 [&>svg]:text-warning-foreground",
        invert:
