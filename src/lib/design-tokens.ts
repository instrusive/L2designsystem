...
// mirror src/app/globals.css — same pattern as component-registry.ts
...
export const colorTokens: ColorToken[] = [
  ...
  { name: "border / input", light: "oklch(0.607 0.013 86.8)", dark: "oklch(0.570 0.003 106.6)", usage: "Component boundaries. Deliberately as dark/light as it can be without failing WCAG 1.4.11 (3:1) against background AND card, which is why it can't be much subtler than this — see the Elevation/Accessibility docs." },
